...
public class ServletSumar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /*Vamos a capturar los parametros: primer y segundo numero*/
        String primer = request.getParameter("primer"); //el nombre "primer" debe ser igual a la propiedad name de la etiqueta input del html
        String segundo = request.getParameter("segundo");
        
        /*Convertimos los parametros de String a int*/
