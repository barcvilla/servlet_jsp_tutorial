...
public class FechaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //le decimos al navegador que la informacion se refresque cada segundo
        response.setHeader("refresh", "1");
        //obtenemos la fecha actual y aplicamos un formatos
        Date fecha = new Date();
        SimpleDateFormat formateador = new SimpleDateFormat("'Hora actualizada' HH:mm:ss");
        //otro formato valido: new SimpleDateFormat("dd 'de' MMMM" 'de' yyyy 'a las' HH:mm:ss");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Fecha actualiza:" + fechaConFormato + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
