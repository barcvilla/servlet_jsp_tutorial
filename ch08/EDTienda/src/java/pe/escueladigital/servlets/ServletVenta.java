...
import pe.escueladigital.dao.PSQLVenta;
...
public class ServletVenta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession sesion = request.getSession();//recupero la Session
        /*Traemos los parametros nombre y direccion del carro.jsp*/
        String nombre = request.getParameter("nombre");
        String direccion = request.getParameter("direccion");
        /*Obtenemos el carro de la session*/
        ...
        /*Retiramos los producto del carro*/
        sesion.removeAttribute("carro");
        
        /*Enviamos el objeto venta a venta.jsp*/
